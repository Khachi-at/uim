...
// Create database uim_base default character set utf8mb4 collate utf8mb4_unicode_ci.
// Create database uim_message default character set utf8mb4 collate utf8mb4_unicode_ci.
